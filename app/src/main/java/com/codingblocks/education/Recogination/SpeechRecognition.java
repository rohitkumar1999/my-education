...
public class SpeechRecognition {
    ...
    public void setSpeechRecognitionPermissionListener(@NonNull OnSpeechRecognitionPermissionListener onSpeechRecognitionPermissionListener){
        ...
        if(!handlePermissions) throw new UnsupportedOperationException("This operation is not supported. Set handleAudioPermissions(true) to allow");
    ...
    public void startSpeechRecognition(){
        ...
        if(!speechRecognitionPermissions.isPermissionGiven(context)){
            ...
            if(!handlePermissions)
                throw new SecurityException("Permission Denial, you must grant RECORD_AUDIO permission or set handleAudioPermissions(true)");
    ...
    private void mutebeepsound(boolean value)
    {
        if(value==true)
        {
    ...
    private void checkProperties(){
        if(onSpeechRecognitionListener == null)
            throw new NullPointerException("OnSpeechRecognitionListener has not been initialized");

        if(handlePermissions){
            if(onSpeechRecognitionPermissionListener == null)
                throw new NullPointerException("OnSpeechRecognitionPermissionListener has not been initialized");
        }
